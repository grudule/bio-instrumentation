...
source_folder = r"C:\Users\alexa\Desktop\bio-instrumentation\tools\segmentation tools\images"
print(source_folder)
json_path = r"C:\Users\alexa\Desktop\bio-instrumentation\tools\segmentation tools\via_project_5Oct2024_0h10m_json.json"
count = 0                                           # Count of total images saved
file_bbs = {}                                       # Dictionary containing polygon coordinates for mask
MASK_WIDTH = 2016				    # Dimensions should match those of ground truth image
MASK_HEIGHT = 1512									
